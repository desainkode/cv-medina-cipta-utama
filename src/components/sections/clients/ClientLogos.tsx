...
export function ClientLogos() {
  ...
  return (
    <section className="py-16 bg-[#0d0d0d] overflow-hidden">
      <div className="container mx-auto px-6 md:px-[80px] mb-12">
        <div className="flex flex-col items-center text-center">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-8 h-[1.5px] bg-[#b31b2c]"></div>
            <span className="text-[#b31b2c] font-black text-[10px] tracking-[0.3em] uppercase italic">{t('client_logo_tag')}</span>
            <div className="w-8 h-[1.5px] bg-[#b31b2c]"></div>
          </div>
