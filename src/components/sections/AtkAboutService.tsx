        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-[#b31b2c] font-black text-xs tracking-[0.4em] uppercase">{t('atk_about_tag')}</span>
            </div>
            ...
            <p className="text-white/70 text-base leading-relaxed font-medium mb-10">
              {t('atk_about_desc_long')}
            </p>

            {/* Grid of Benefits */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                { icon: PackageCheck, text: t('atk_about_item1') },
                { icon: BadgePercent, text: t('atk_about_item2') },
                { icon: Truck, text: t('atk_about_item3') },
                { icon: ShieldCheck, text: t('atk_about_item4') }
              ].map((item, i) => (
